...
use exface\SapConnector\DataConnectors\SapHanaSqlConnector;

/**
 * @method SapHanaSqlConnector getDataConnector()
 * 
    ...
    public function getAttributeDataFromTableColumns(MetaObjectInterface $meta_object, string $table_name) : array
    {
        ...
        foreach ($columns_array as $col) {
            $rows[] = array(
                ...
                'DATATYPE' => $this->getDataTypeId($this->guessDataType($meta_object, $col['DATA_TYPE_NAME'])),
